package com.example.meetflow.database
...
class DatabaseHelper(context: Context)
    ...
    companion object {
        ...
        private const val TABLE_USUARIO_REUNIAO =
            "usuario_reuniao"

        private const val COLUMN_UR_USUARIO_ID =
            "usuario_id"

        private const val COLUMN_UR_REUNIAO_ID =
            "reuniao_id"
    ...
    fun contarUsuarios(): Int {
        ...
        val query =
            "SELECT COUNT(*) FROM $TABLE_USUARIO"
    ...
    fun inserirUsuario(
        ...
        values.put(COLUMN_USUARIO_TELEFONE, telefone)
    ...
    fun listarReunioes(): List<Reuniao> {
        ...
        val listaReunioes =
            mutableListOf<Reuniao>()

        val db = this.readableDatabase

        val query =
            "SELECT * FROM $TABLE_REUNIAO"
    ...
    fun buscarReuniaoPorId(
        ...
        val query =
            "SELECT * FROM $TABLE_REUNIAO WHERE $COLUMN_REUNIAO_ID = ?"
    ...
    fun contarReunioes(): Int {
        ...
        val query =
            "SELECT COUNT(*) FROM $TABLE_REUNIAO"
    ...
    fun inserirReuniao(
        ...
        values.put(
            COLUMN_REUNIAO_TITULO,
            titulo
        )

        values.put(
            COLUMN_REUNIAO_DESCRICAO,
            descricao
        )
    ...
    fun deletarRelacionamentosReuniao(
        reuniaoId: Int
    ) {
    ...
    fun deletarRelacionamentosUsuario(
        usuarioId: Int
    ) {
    ...
    fun contarParticipantes(
        ...
        ON usuario.$COLUMN_USUARIO_ID =
           ur.$COLUMN_UR_USUARIO_ID
    ...
    fun buscarParticipantesDaReuniao(
        reuniaoId: Int
    ): List<User> {
