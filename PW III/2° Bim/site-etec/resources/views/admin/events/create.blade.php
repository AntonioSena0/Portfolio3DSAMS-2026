<x-app-layout>
    <section class="bg-[#F5F5F5] py-14">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="mt-2 text-4xl font-bold text-[#313131]">Criar evento</h1>
        </div>
    </section>

    <section class="py-14">
        <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            <form action="{{ route('admin.events.store') }}" method="POST" class="bg-white p-8 shadow-sm">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="category" id="category"
                            ...
                            <option value="destaque" @selected(old('category') == 'destaque')>Destaque</option>
                            <option value="noticia" @selected(old('category') == 'noticia')>Notícia</option>
                            <option value="evento" @selected(old('category') == 'evento')>Evento</option>
                            <option value="comunicado" @selected(old('category') == 'comunicado')>Comunicado</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="target_grade" id="target_grade"
                            ...
                            <option value="1" @selected(old('target_grade') == '1')>1º Ano</option>
                            <option value="2" @selected(old('target_grade') == '2')>2º Ano</option>
                            <option value="3" @selected(old('target_grade') == '3')>3º Ano</option>
                        </select>
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3"
                            class="mt-1 block w-full border border-[#DDD] px-4 py-3 text-sm text-[#313131] focus:border-[#B20000] focus:outline-none">{{ old('excerpt') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="10" required
                            class="mt-1 block w-full border border-[#DDD] px-4 py-3 text-sm text-[#313131] focus:border-[#B20000] focus:outline-none">{{ old('content') }}</textarea>
